...
import { buildWakeMessage, estimateTokens, type WakeMessageEntry } from './wake-message'
...
describe('buildWakeMessage — scheduled_followup', () => {
  test('uses payload reason', () => {
    ...
    expect(result).toBe('Scheduled follow-up: Weekly check-in. Read conversation/messages.md for context.')
  })
...
describe('buildWakeMessage — supervisor', () => {
  test('uses payload instruction', () => {
    ...
    expect(result).toBe('Supervisor instruction: Escalate to human. Read conversation/messages.md for context.')
  })
...
describe('buildWakeMessage — manual', () => {
  test('uses payload reason', () => {
    ...
    expect(result).toBe('Manual wake: Debug issue. Read conversation/messages.md for context.')
  })
