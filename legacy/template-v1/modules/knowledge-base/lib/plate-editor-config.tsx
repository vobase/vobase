...
function H1Element(props: PlateElementProps) {
  return <PlateElement {...pe(props)} className="mb-2 mt-5 text-lg font-semibold tracking-tight first:mt-0" />
}

function H2Element(props: PlateElementProps) {
  return <PlateElement {...pe(props)} className="mb-1.5 mt-4 text-base font-semibold first:mt-0" />
}

function H3Element(props: PlateElementProps) {
  return <PlateElement {...pe(props)} className="mb-1 mt-3 text-sm font-semibold first:mt-0" />
}

function H4Element(props: PlateElementProps) {
  return <PlateElement {...pe(props)} className="mb-1 mt-2 text-sm font-medium first:mt-0" />
}
...
function H6Element(props: PlateElementProps) {
  return <PlateElement {...pe(props)} className="mb-1 mt-2 text-sm font-medium text-muted-foreground first:mt-0" />
}

function BlockquoteElement(props: PlateElementProps) {
  return <PlateElement {...pe(props)} className="my-3 border-l-2 border-border pl-4 italic text-muted-foreground" />
}

function CodeBlockElement(props: PlateElementProps) {
  return (
    <PlateElement {...pe(props)} className="my-3 overflow-x-auto rounded-md bg-muted px-4 py-3 font-mono text-sm" />
  )
}
...
function UlElement(props: PlateElementProps) {
  return <PlateElement {...pe(props)} className="my-2 ml-4 list-disc space-y-0.5 text-sm" />
}

function OlElement(props: PlateElementProps) {
  return <PlateElement {...pe(props)} className="my-2 ml-4 list-decimal space-y-0.5 text-sm" />
}
...
function TableElement(props: PlateElementProps) {
  return <PlateElement {...pe(props)} as="table" className="my-3 w-full border-collapse text-sm" />
}

function TableRowElement(props: PlateElementProps) {
  return <PlateElement {...pe(props)} as="tr" className="border-b border-border" />
}

function TableCellElement(props: PlateElementProps) {
  return <PlateElement {...pe(props)} as="td" className="border border-border px-3 py-2 text-sm" />
}
...
export const documentComponents: Record<string, (props: PlateElementProps) => ReactElement | null> = {
