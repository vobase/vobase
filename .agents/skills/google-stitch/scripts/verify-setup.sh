...
if [ -f "components.json" ]; then
    ...
    echo -e "  ${YELLOW}Run:${NC} bunx shadcn@latest init"
    exit 1
fi
...
if [ -d "src/components/ui" ] || [ -d "components/ui" ]; then
    ...
    echo "  Add your first component: bunx shadcn@latest add button"
fi
...
echo ""
echo "Next steps:"
echo "  1. Add components: bunx shadcn@latest add [component]"
echo "  2. View catalog: bunx shadcn@latest add --help"
