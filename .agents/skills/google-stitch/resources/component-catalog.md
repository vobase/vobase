...
### Data Table Pattern
```bash
bunx shadcn@latest add table button dropdown-menu
npm install @tanstack/react-table
```

### Dashboard Layout Pattern
```bash
bunx shadcn@latest add card tabs badge avatar
```

### Authentication Pattern
```bash
bunx shadcn@latest add card input label button tabs
```
...
```bash
# Essential forms
bunx shadcn@latest add form input label button select checkbox

# Data display
bunx shadcn@latest add table badge avatar progress skeleton

# Overlay/modal components
bunx shadcn@latest add dialog sheet popover tooltip alert-dialog

# Navigation
bunx shadcn@latest add navigation-menu breadcrumb pagination

# Layout
bunx shadcn@latest add card accordion tabs separator
```
