...
**RO enforcement by scope.** `ScopedFs` blocks agent writes to `/workspace/drive/**` (organization scope, proposal flow only) and `/workspace/AGENTS.md` (auto-generated from registered tools/commands/skills). Agent-writable: `/workspace/MEMORY.md`, `/workspace/contact/notes.md`, `/workspace/contact/drive/**`, `/workspace/tmp/**`.
...
/workspace/drive/         organization-scope (RO, proposal for writes)
/workspace/drive/BUSINESS.md   organization brand/products/policies, seeded at provisioning
