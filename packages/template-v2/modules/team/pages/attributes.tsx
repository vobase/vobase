...
export function StaffAttributeDefinitionsPage() {
  ...
  const [editing, setEditing] = useState<StaffAttributeDefinition | null>(null)
  const [deleteTarget, setDeleteTarget] = useState<StaffAttributeDefinition | null>(null)
  ...
  function openEdit(def: StaffAttributeDefinition) {
    setEditing(def)
    setDialogOpen(true)
  }
  ...
  async function handleToggleVisibility(def: StaffAttributeDefinition) {
    try {
    ...
    <div className="flex h-full flex-col overflow-hidden">
      <header className="flex shrink-0 items-center gap-3 border-b border-border px-6 py-4">
        ...
        <div className="flex-1">
          <h1 className="text-lg font-semibold tracking-tight">Staff attributes</h1>
        ...
        {!isLoading && defs.length === 0 && (
          <div className="flex h-full items-center justify-center">
            <Empty>
              ...
              <EmptyDescription>
                Add attributes like "Department", "Seniority" or "On-call" to keep consistent info on every staff
                member.
              </EmptyDescription>
              <div className="mt-3">
                <Button size="sm" onClick={openCreate}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              staff form. Existing values stored on staff profiles are kept but will no longer appear.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
...
export const Route = createFileRoute('/_app/team/attributes')({
  component: StaffAttributeDefinitionsPage,
})
