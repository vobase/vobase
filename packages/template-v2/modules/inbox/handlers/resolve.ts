/**
 * POST /api/inbox/conversations/:id/resolve — staff resolve (active→resolved)
 * POST /api/inbox/conversations/:id/reopen  — staff reopen  (resolved→active)
 * POST /api/inbox/conversations/:id/reset   — staff reset failed (failed→active)
 */
