...
mock.module('@modules/inbox/components/profile-panel', () => ({
...
mock.module('@modules/inbox/components/pending-approvals-panel', () => ({
...
mock.module('@modules/inbox/components/working-memory-panel', () => ({
  WorkingMemoryPanel: ({ conversationId }: { conversationId: string }) => (
    <div data-testid="working-memory-panel" data-conv={conversationId} />
  ),
}))

mock.module('@modules/inbox/components/recent-learnings-panel', () => ({
