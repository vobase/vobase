...
function makeContactsServiceStub(): ContactsService {
  ...
  return {
    ...
    readMemory: notImplemented as ContactsService['readMemory'],
    upsertMemorySection: notImplemented as ContactsService['upsertMemorySection'],
    appendMemory: notImplemented as ContactsService['appendMemory'],
    removeMemorySection: notImplemented as ContactsService['removeMemorySection'],
...
function installTestState(isNewMessage = true, auth: Auth | null = null): void {
  ...
  installChannelsState(createChannelsState({ jobs, auth }))
}
