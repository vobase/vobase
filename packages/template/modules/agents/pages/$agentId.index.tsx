    ...
    <div className="p-6 space-y-6">
      ...
      <div className="rounded-xl border bg-card p-5 space-y-4">
        ...
        <div className="flex items-center justify-between pt-1">
          <div>
            {saveMutation.isError && <p className="text-xs text-destructive">Failed to save changes</p>}
            {saveMutation.isSuccess && !dirty && <p className="text-xs text-muted-foreground">Changes saved</p>}
          </div>
      ...
      <div className="space-y-3">
        <h2 className="text-sm font-medium text-muted-foreground">Workspace Files</h2>
              ...
              <FileRow
                ...
                menuItems={
                  <DropdownMenuItem asChild>
                    <Link to="/agents/$agentId/editor" params={{ agentId }} search={{ path: file.path }}>
                      Edit
                    </Link>
                  </DropdownMenuItem>
                }
