...
export function FileRow({
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-accent/50 group">
      {content}
    </div>
  );
}
...
export function FileCard({
  ...
  const content = (
    <>
      <div
        className={`flex size-10 items-center justify-center rounded-lg ${ICON_BG[icon]}`}
      >
