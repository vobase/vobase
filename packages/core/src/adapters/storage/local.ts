...
import type { LocalAdapterConfig, StorageAdapter, StorageObjectInfo } from '../../contracts/storage'
import { validation } from '../../errors'

function sanitizePath(inputPath: string): string {
  if (inputPath.includes('..')) {
    throw validation({ path: inputPath }, 'Invalid path: directory traversal not allowed')
  }
