...
export interface ChannelAdapter {
  ...
  getSessionContext?(session: { windowExpiresAt: Date | null; sessionState: string | null }): string | null
}
...
export type ChannelEvent = MessageReceivedEvent | StatusUpdateEvent | ReactionEvent
